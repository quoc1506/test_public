function checkUser(type) {
	...
	switch (type) {
		case 1: // daily // 22h
			user = {username: ".sv@4723027;vn.", password: "K8UtcPmeMDHqPInTEvcXicnPPNm0GQnchlLMX9DcOyMIxfaFvxCrRg=="};
			break;
		case 15: // dailyibvpn
			user = {username: "xsk51599@eoopy.com", password: "2zJg7xtQNQ"};
			break;
		case 16: // 3 day 22h 08/05
			user = {username: "xsk51599@eoopy.com", password: "xsk51599@eoopy.com"};
			break;
		case 2: // weekly 22h 08/05
			user = {username: "purevpn0s9409490", password: "xg7ju7tf"};
			break;
		case 3:
			...
			break;
		case 4:
			user = {username: "*cookie_ZHEuIFdfZCMjI2xQRnJpR2pmfFg5YyhySEhQIyMjbTpUPS9uS1dhVW1VMW4tWixPXT1WTUw6_chromeapp_3_Mon Dec 16 2019 11:07:38 GMT+0700 (Indochina Time)", password: ""};
			break;
		case 5:
			user = {username: "Z42myeXkKRfDU2TGNJDxhcCu", password: "HNxyRvSNcsiC5jFGt3dmpVN4"};
			break;
		case 6: // limit storage
			user = {username: "nguyenlinh6605@gmail.com", password: "e3658b80cf986109c366fea29c1a1858"};
			break;
		case 7:
			user = {username: "DictOciafDocyangEzbawuj1", password: "bavpensacpyubEfketDiwrir"};
			break;
		case 8:
			user = {username: "access_token", password: "dkrp6i7bssgv8p4gtdrnnjlne08rmoqukaghm7c930v7jkq7f5d"};
			break;
		case 9:
		...
		case 13:
			...
			break;
		case 14:
			user = {username: "testuser1", password: "e4b72b531a2d10900519"};
			break;
		case 17: 
			user = {username: "alpsancar48@gmail.com", password: "UXZJSUVtnmDG3DkptkA4"};
			break;
		case 18: 
			user = {username: "pg-952bd832", password: "79ab2543"};
			break;
		case 19: 
